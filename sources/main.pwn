...
// Colors
#define COLOR_BLUE					(0x8D8DFF00) // Ãîëóáîé öâåò. Èñïîëüçóåòñÿ òîëüêî â êîìàíäå /v, êîãäà èãðîê ïèøåò â ðàöèþ ìàøèíû
#define COLOR_GREY 					(0x696969FF) // Ñåðûé öâåò. Èñïîëüçóåòñÿ ïðè âûâîäå îøèáîê è â êîìàíäå /v

// Strings
#define VEHICLE_ENTER_MSG 			"Èñïîëüçóéòå: /v [ òåêñò ]"

#define VEHICLE_EXIT_DIALOG_CAPTION	"Âûõîä | {BC2C2C}Òðàíñïîðò"
#define VEHICLE_EXIT_DIALOG_MSG 	"\n{FFFFFF}Âû äåéñòâèòåëüíî æåëàåòå ïîêèíóòü òðàíñïîðòíîå ñðåäñòâî?\n\n \
									Ðàéîí: %s\n" // ïðè èçìåíåèè òåêñòà, íå çàáóäüòå èçìåíèòü çíà÷åíèå VEHICLE_EXIT_DIALOG_MSG_LN íèçó

#define VEHICLE_EXIT_DIALOG_BTN_1	"»"
#define VEHICLE_EXIT_DIALOG_BTN_2	"x"

#define UNKNOWN_AREA_MSG			"Íå îïðåäåëåí" 
#define FRONT_COMPARTMENT_MSG 		"Ïåðåäíèé ñàëîí" // ïðè èçìåíåèè òåêñòà, íå çàáóäüòå èçìåíèòü çíà÷åíèå COMPARTMENT_MSG_LN íèçó
#define REAR_COMPARTMENT_MSG 		"Çàäíèé ñàëîí" // ïðè èçìåíåèè òåêñòà, íå çàáóäüòå èçìåíèòü çíà÷åíèå COMPARTMENT_MSG_LN íèçó
#define VEHICLE_CRASH_MSG			"Âàø ãðóçîâèê ïîòåðïåë àâàðèþ"
#define VEHICLE_EXIT_ERROR_MSG		"Ñêîðîñòü ãðóçîâèêà ñëèøêîì âåëèêà. Ïîäîæäèòå, ïîêà ìàøèíà îñòàíîâèòñÿ" 
...
#define VEHICLE_EXIT_DIALOG_MSG_LN	(79) // äëèíà ñòðîêè VEHICLE_EXIT_DIALOG_MSG (íå ó÷èòûâàÿ ñïåöèôèêàòîðîâ, ëèòåðàëîâ è '\0')
#define MIN_SPEED_FOR_EXIT_ERROR	(20.00) // åñëè ñêîðîñòü ò/ñ áóäåò âûøå óêàçàííîé, òî èãðîê íå ñìîæåò âûéòè èç èíòåðüåðà
#define COMPARTMENT_MSG_LN 			(14) // äëèíà ñòðîêè REAR_COMPARTMENT_MSG èëè FRONT_COMPARTMENT_MSG, ñìîòðÿ êàêîé èç íèõ ñàìûé äëèííûé (íå ó÷èòûâàÿ ñïåöèôèêàòîðîâ, ëèòåðàëîâ è '\0')
/* ================================= Global Arrays =================================*/


new PlayerVehicleID[MAX_PLAYERS char];
new Iterator: TruckPassengers[MAX_VEHICLES]<MAX_PLAYERS>;
new const Float: InteriorPositions[][] = // êîîðäèíàòû íà òåëåïîðò â ñàëîíû
{
...
// Ó ìåíÿ ïî÷åìó-òî íå ïîëó÷èëîñü ïåðåòàùèòü ïàáëèêè â îòäåëüíûå ôàéëû, òàêè íå ñìîã ïîíÿòü â ÷¸ì äåëî.
// Ðàíüøå ñ òàêèì íèêîãäà íå âñòðå÷àëñÿ, íî âñåãäà äåëàë òàê. Åñëè çíàåòå â ÷åì äåëî, îòïèøèòåñü â òåìå =)
...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
	if(dialogid == VEHICLE_EXIT_DIALOG_ID)
	{
		if(response)
		{
			...
			/// Âàæíî! Åñëè â âàøåì ìîäå íå èñêëþ÷åíî ïîÿâëåíèå ò/ñ â èíòåðüåðå, òî çàáóäüòå îá ýòîì ñêðèïòå! 
			/// Âàì íàäî íàïèñàòü ñâîé GetVehicleInterior(vehicleid), òàê êàê â SAMP åãî íåò 
